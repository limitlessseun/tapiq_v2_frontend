      ...
      <div className="w-full md:w-1/2 mx-auto">
        <div className="w-full mx-auto text-center mb-8 md:mb-12">
          ...
          <p className="text-base md:text-lg text-indigo leading-relaxed">
            Have any questions, feedback, or need assistance? Fill out the form
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center md:mb-8 mb-4">
          <div className="relative p-4 flex items-center justify-center overflow-hidden w-full mx-auto rounded-lg">
            ...
            <div className="w-full max-w-md relative z-10 flex flex-col text-white">
              ...
              <div className="w-full">
                ...
                <textarea
                  className=" w-full h-[60px] pr-10 bg-white!
              focus:outline-none
              ...
              <Button className="bg-gradient-to-br from-[#575EFF] to-[#282D99] uppercase font-semibold text-base md:text-lg w-full px-8 py-6 complex-gradient-border text-white my-6">
                send
              </Button>
            </div>
          </div>
          <div className="flex flex-col">
            <div className="w-full mx-auto text-center mb-2 md:mb-6">
              ...
              <p className="text-base md:text-lg text-indigo leading-relaxed">
                For any inquiries, feel free to reach out to us through the
            ...
            <div className="flex flex-col">
              <div className="flex items-center -my-6">
                ...
                <div className="flex flex-col gap-1 -ml-2">
                  <h3 className="font-semibold text-xl md:text-2xl text-indigo ">
                    Email
                  </h3>
