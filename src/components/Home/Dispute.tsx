      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="">
          ...
          <div className="mb-12">
            ...
            <div className="mb-6">
              <label className="block mb-3 text-gray font-medium">
                Upload Business Proof (CAC certificate, store screenshots,
                delivery records)
              </label>
              <div className="flex gap-4">
                {[1, 2, 3].map((item) => (
                  <div
                    key={item}
                    className="w-40 h-40 bg-white rounded-lg flex items-center justify-center cursor-pointer  transition-colors"
                  >
                    <Image
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block mb-3 text-indigo ">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <Button className="bg-gradient-to-br from-[#575EFF] to-[#282D99] uppercase font-semibold text-lg w-full py-6 complex-gradient-border text-white mt-6">
                SUBMIT DISPUTE
              </Button>
            </div>
          </div>
