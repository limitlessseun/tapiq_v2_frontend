  ...
  return (
    <>
        ...
        <div className=" mx-auto px-4 md:px-24">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              <Button
                className={`px-6 py-2 border-2 rounded-lg complex-gradient-borderhover:bg-white/10  text-sm font-medium ${getTextColor()}`}
              >
                REPORT A VENDOR
              </Button>
      ...
      >
        ...
        {isOpen && (
          <div
            className={`transition-all duration-300 h-screen pb-6 ${getBackgroundClass()}`}
          >
